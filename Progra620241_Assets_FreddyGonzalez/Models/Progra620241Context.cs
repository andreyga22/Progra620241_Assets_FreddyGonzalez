...
namespace Progra620241_Assets_FreddyGonzalez.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AssetId).HasName("PK__Asset__43492372E0B9F652");
        ...
        {
            entity.HasKey(e => e.AssetCategoryId).HasName("PK__AssetCat__C381F49DEE6EBA38");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCD95576CA9");
        ...
        {
            entity.HasKey(e => e.DepreciationId).HasName("PK__Deprecia__DEEBFE2958687747");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC3D725726");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A55BA60687B");
